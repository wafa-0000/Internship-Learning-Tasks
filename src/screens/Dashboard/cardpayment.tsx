...
import {
  View, Text, StyleSheet, TouchableOpacity, TextInput, Modal, KeyboardAvoidingView, Platform, Alert, ScrollView, ActivityIndicator
} from 'react-native';
...
const CardPayment = () => {
  ...
  const onCancel = () => setConfirmModalVisible(false);
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.formContainer}>
            ...
            <TextInput style={styles.input} placeholder="1234 5678 9012 3456" placeholderTextColor="#606063" keyboardType="numeric" value={cardNumber} onChangeText={setCardNumber} />
            
            <View style={styles.row}>
              <View style={{flex: 1, marginRight: 10}}>
                <Text style={styles.label}>Expiry Date</Text>
                <TextInput style={styles.input} placeholder="MM/YY" placeholderTextColor="#606063" value={expiryDate} onChangeText={setExpiryDate} />
              </View>
              <View style={{flex: 1}}>
                <Text style={styles.label}>CVV</Text>
                <TextInput style={styles.input} placeholder="123" placeholderTextColor="#606063" keyboardType="numeric" secureTextEntry value={cvv} onChangeText={setCvv} />
              </View>
            </View>
            <Text style={styles.label}>Cardholder Name</Text>
            <TextInput style={styles.input} placeholder="John Doe" placeholderTextColor="#606063" value={cardHolderName} onChangeText={setCardHolderName} />
          </View>
        ...
        {/* Modal: Confirm */}
        <Modal transparent={true} visible={confirmModalVisible} animationType="fade">
          <View style={styles.modalOverlay}>
            <View style={styles.modalView}>
              {loading ? <ActivityIndicator size="large" color="#F3E932" /> : (
                <>
                  ...
                  <View style={styles.modalActions}>
                    <TouchableOpacity style={styles.cancelBtn} onPress={onCancel}><Text style={{color: '#FFF'}}>Cancel</Text></TouchableOpacity>
                    <TouchableOpacity style={styles.continueBtn} onPress={onConfirm}><Text style={{color: '#000', fontWeight: 'bold'}}>Continue</Text></TouchableOpacity>
                  </View>
                </>
              )}
            </View>
        ...
        <Modal transparent={true} visible={successModalVisible} animationType="fade">
          <View style={styles.modalOverlay}>
            <View style={styles.modalView}>
              ...
              <TouchableOpacity style={styles.continueBtn} onPress={onFinish}><Text style={{color: '#000', fontWeight: 'bold'}}>Back to Vault</Text></TouchableOpacity>
            </View>
          </View>
        </Modal>
